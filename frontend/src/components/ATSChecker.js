      ...
      <header className="modern-header">
        <div className="container header-content">
          ...
          <nav className="fade-in">
            <button onClick={() => navigate('/ats-checker')} className="button secondary-button">ATS Checker</button>
            <button onClick={() => navigate('/resume-builder')} className="button secondary-button">Resume Builder</button>
            <button 
              onClick={() => {
