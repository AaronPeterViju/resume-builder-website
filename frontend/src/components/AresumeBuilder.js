      ...
      <header className="header">
        <div className="header-content">
          ...
          <nav>
            ...
            <button onClick={() => navigate('/AresumeBuilder')} className="modern-button secondary">Resume Builder</button>
            <button onClick={() => navigate('/admin-dashboard')} className="modern-button secondary">AdminDashboard</button>
            <button 
              onClick={() => {
